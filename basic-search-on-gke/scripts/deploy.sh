...
kubectl cp src/main/application/hosts.xml vespa-0:/workspace
kubectl cp src/main/application/services.xml vespa-0:/workspace
kubectl cp src/main/application/searchdefinitions vespa-0:/workspace
