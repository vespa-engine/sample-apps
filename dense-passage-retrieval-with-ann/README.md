...
$ python3 ./bin/model-export.py
$ python3 ./bin/query-model-export.py
$ mv reader.onnx src/main/application/files/
$ mv question_encoder.onnx src/main/application/files/
$ mvn clean package
</pre>
...
## How to run entire dataset with tests

* To run the full dataset, minimum **128GB** system memory
