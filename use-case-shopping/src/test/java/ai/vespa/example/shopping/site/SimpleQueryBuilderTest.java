...
public class SimpleQueryBuilderTest {
    ...
    public void testQueryBuilding() {
        ...
        assertEquals("/search/?summary=short&hits=0&yql=select+*+from+sources+item+where+default+contains+%22shoes%22+%7C+all%28+group%28brand%29+each%28output%28count%28%29%29%29+%29%22%3B", query.toString());
    }
