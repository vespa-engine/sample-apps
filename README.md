...
The [![logo](vespa-logomark-tiny.png) simple semantic search](simple-semantic-search/)
...
The [![logo](vespa-logomark-tiny.png) Vespa Multi-Vector Indexing with HNSW](multi-vector-indexing/) /
[![logo](vespa-logomark-tiny.png) Pyvespa: Multi-vector indexing with HNSW](https://pyvespa.readthedocs.io/en/latest/examples/multi-vector-indexing.html)
...
[![logo](vespa-logomark-tiny.png) Pyvespa: Evaluating retrieval with Snowflake arctic embed](https://pyvespa.readthedocs.io/en/latest/examples/evaluating-with-snowflake-arctic-embed.html).
...
[![logo](vespa-logomark-tiny.png) Pyvespa: Using Mixedbread.ai embedding model with support for binary vectors](https://pyvespa.readthedocs.io/en/latest/examples/mixedbread-binary-embeddings-with-sentence-transformers-cloud.html)
...
## Visual search
[![logo](vespa-logomark-tiny.png) Pyvespa: Vespa 🤝 ColPali: Efficient Document Retrieval with Vision Language Models](https://pyvespa.readthedocs.io/en/latest/examples/colpali-document-retrieval-vision-language-models-cloud.html).
...
[![logo](vespa-logomark-tiny.png) Pyvespa: Scaling ColPALI (VLM) Retrieval](https://pyvespa.readthedocs.io/en/latest/examples/simplified-retrieval-with-colpali-vlm_Vespa-cloud.html)
...
[![logo](vespa-logomark-tiny.png) Pyvespa: ColPali Ranking Experiments on DocVQA](https://pyvespa.readthedocs.io/en/latest/examples/colpali-benchmark-vqa-vlm_Vespa-cloud.html).
...
[![logo](vespa-logomark-tiny.png) Pyvespa: PDF-Retrieval using ColQWen2 (ColPali) with Vespa](https://pyvespa.readthedocs.io/en/latest/examples/pdf-retrieval-with-ColQwen2-vlm_Vespa-cloud.html).
...
## Ranking
[![logo](vespa-logomark-tiny.png) Pyvespa: Using Mixedbread.ai cross-encoder for reranking in Vespa.ai](https://pyvespa.readthedocs.io/en/latest/examples/cross-encoders-for-global-reranking.html).
...
[![logo](vespa-logomark-tiny.png) Pyvespa: Standalone ColBERT with Vespa for end-to-end retrieval and ranking](https://pyvespa.readthedocs.io/en/latest/examples/colbert_standalone_Vespa-cloud.html).
...
[![logo](vespa-logomark-tiny.png) Pyvespa: Standalone ColBERT + Vespa for long-context ranking](https://pyvespa.readthedocs.io/en/latest/examples/colbert_standalone_long_context_Vespa-cloud.html).
...
The main goal of [![logo](vespa-logomark-tiny.png) Pyvespa: LightGBM: Training the model with Vespa features](https://pyvespa.readthedocs.io/en/latest/examples/lightgbm-with-categorical.html)
...
## Performance
[![logo](vespa-logomark-tiny.png) Pyvespa: Feeding performance](https://pyvespa.readthedocs.io/en/latest/examples/feed_performance.html)
...
Try [![logo](vespa-logomark-tiny.png) Feeding to Vespa Cloud](https://pyvespa.readthedocs.io/en/latest/examples/feed_performance_cloud.html)
...
The [![logo](vespa-logomark-tiny.png) news](news/) sample application used in the [Vespa tutorial](https://docs.vespa.ai/en/tutorials/news-1-getting-started.html).
...
This [![logo](vespa-logomark-tiny.png) billion-scale-image-search](billion-scale-image-search/) app demonstrates 
...
This [![logo](vespa-logomark-tiny.png) msmarco-ranking](msmarco-ranking/) application demonstrates 
...
See also the more simplistic [![logo](vespa-logomark-tiny.png) text-search](text-search) app that demonstrates 
traditional text search using BM25/Vespa nativeRank.


### Next generation E-Commerce Search
The [![logo](vespa-logomark-tiny.png) use-case-shopping](use-case-shopping/) app creates an end-to-end E-Commerce shopping engine.
...
See also the [![logo](vespa-logomark-tiny.png) commerce-product-ranking](commerce-product-ranking/) sample application for using
...
The [![logo](vespa-logomark-tiny.png) incremental-search](incremental-search/) application demonstrates search-as-you-type functionality,
...
The [![logo](vespa-logomark-tiny.png) model-inference](model-inference/) application demonstrates 
...
[![logo](vespa-logomark-tiny.png) vespa-documentation-search](https://github.com/vespa-cloud/vespa-documentation-search)
...
### CORD-19 Search
[![logo](vespa-logomark-tiny.png) cord19.vespa.ai](https://cord19.vespa.ai/) is a full-featured application,
