...
[![logo](assets/vespa-logomark-tiny.png) vector-search](https://github.com/vespa-cloud/vector-search),
...
## Getting started
[![logo](assets/vespa-logomark-tiny.png) album-recommendation](album-recommendation/) is the intro application to Vespa.
...
The [![logo](assets/vespa-logomark-tiny.png) vector-streaming-search](vector-streaming-search) app
...
[![logo](assets/vespa-logomark-tiny.png) multilingual](multilingual-search)
...
The [![logo](assets/vespa-logomark-tiny.png) splade](splade) application demonstrates how to
...
[![logo](assets/vespa-logomark-tiny.png) custom-embeddings](custom-embeddings)
...
* [![logo](assets/vespa-logomark-tiny.png) simple hybrid search with ColBERT](colbert)
  ...
  [![logo](assets/vespa-logomark-tiny.png) colbert-embedder](https://docs.vespa.ai/en/embedding.html#colbert-embedder)
  for explainable semantic search with better accuracy than regular text embedding models.
* The [![logo](assets/vespa-logomark-tiny.png) Long-Context ColBERT](colbert-long)
...
The [![logo](assets/vespa-logomark-tiny.png) retrieval-augmented-generation](retrieval-augmented-generation) sample application
...
The main goal of [![logo](assets/vespa-logomark-tiny.png) Pyvespa: LightGBM: Training the model with Vespa features](https://pyvespa.readthedocs.io/en/latest/examples/lightgbm-with-categorical.html)
...
Try [![logo](assets/vespa-logomark-tiny.png) Feeding to Vespa Cloud](https://pyvespa.readthedocs.io/en/latest/examples/feed_performance_cloud.html)
...
The [![logo](assets/vespa-logomark-tiny.png) news](news/) sample application used in the [Vespa tutorial](https://docs.vespa.ai/en/tutorials/news-1-getting-started.html).
...
This [![logo](assets/vespa-logomark-tiny.png) billion-scale-image-search](billion-scale-image-search/) app demonstrates 
...
This [![logo](assets/vespa-logomark-tiny.png) msmarco-ranking](msmarco-ranking/) application demonstrates 
...
See also the more simplistic [![logo](assets/vespa-logomark-tiny.png) text-search](text-search) app that demonstrates 
traditional text search using BM25/Vespa nativeRank.


### Next generation E-Commerce Search
The [![logo](assets/vespa-logomark-tiny.png) use-case-shopping](use-case-shopping/) app creates an end-to-end E-Commerce shopping engine.
...
See also the [![logo](assets/vespa-logomark-tiny.png) commerce-product-ranking](commerce-product-ranking/) sample application for using
...
The [![logo](assets/vespa-logomark-tiny.png) incremental-search](incremental-search/) application demonstrates search-as-you-type functionality,
...
The [![logo](assets/vespa-logomark-tiny.png) model-inference](model-inference/) application demonstrates 
