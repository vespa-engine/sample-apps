...
Follow these steps to deploy an application to the [dev zone](https://docs.vespa.ai/en/operations/zones.html) in the Vespa Cloud. Find more details and tips in the [developer guide](https://docs.vespa.ai/en/applications/developer-guide).
