...
A simple book search application demonstrating how to use vespa-testcontainers for
integration testing (depends on internal repo vespa-testcontainers for now)
