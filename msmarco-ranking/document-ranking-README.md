...
This step also downloads the three ONNX models used in this application package.
The download script used is [download_models.sh](src/main/bash/download_models.sh):
